...
int* CPPMathLibrary::ContinuedFraction::ContinuedFractionExpansion(double gamma, size_t& count, size_t& op_count) {
...
CPPMathLibrary::RationalNumber CPPMathLibrary::ContinuedFraction::FindConvergent(int* qs, size_t stop_index) {
...
void CPPMathLibrary::ContinuedFraction::PrintConvergents(int* qs, size_t count) {
